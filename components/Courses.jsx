...
import Image1 from '../public/abc (1).svg'
      ...
      <section className="courses" id='course'>
        <figure className="position-absolute top-0 start-0">
          <svg width="818.6px" height="235.1px">
            <path className="fill-orange opacity-5"
        ...
        <figure className="position-absolute bottom-0 start-0 mb-3">
          <svg enableBackground="new 0 0 223 134" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
            ...
            <path className="fill-success" d="m65.5 1.5h-2.9c-0.6 0-0.6 0.9 0 0.9h2.9c0.6 0 0.6-0.9 0-0.9z"></path>
            <path className="fill-success"
            ...
            <path className="fill-success" d="m6.4 36.1v2.6c0 0.6 0.9 0.6 0.9 0v-2.6c0-0.6-0.9-0.6-0.9 0z"></path>
            <path className="fill-success"
        ...
        <div className="container position-relative py-5">
          <div className="row">
            <div className="col courses-text mx-auto">
