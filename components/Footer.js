        ...
        <div className="container position-relative">
          ...
          <div className="row">
            <div className="col-lg-6 mx-auto text-center mb-5">
              <p className="mt-3 text-white">Lakshya Academy, built specifically for the education centers which is
              ...
              <div className="text-white text-primary-hover mt-3"> Copyrights <a href="#" className="text-reset">©2022 Lakshya Academy</a>.
                All rights reserved. 
              </div>
            </div>
          </div>
