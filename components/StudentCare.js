      ...
      <section className="care">
        ...
        <figure className="position-absolute top-50 start-0 translate-middle-y ms-5 d-none d-md-block">
          <svg enableBackground="new 0 0 44.1 76.2">
            ...
            <path className="fill-orange"
              d="m8.1 33.5c0 0.7-0.6 1.3-1.2 1.3-0.5 0-0.9-0.4-0.8-1 0-0.7 0.6-1.3 1.1-1.3 0.5 0.1 0.9 0.5 0.9 1z"></path>
            <path className="fill-orange"
        ...
        <figure className="position-absolute top-40 end-0 translate-middle-y me-5 d-none d-lg-block">
          <svg width="81.3px" height="106.2px">
            <path className="fill-danger"
        ...
        <div className="row g-lg-5 mt-3 mx-auto">
          <div className="col-md-6 col-lg-4 text-center position-relative">
            ...
            <div className="care-image">
              ...
              <div className="text-care">
                <h5>We care about kids
                </h5>
                <p>Man children rejoiced. Yet uncommonly his ten who diminution astonished.
          ...
          <div className="col-md-6 col-lg-4 text-center pt-0 pt-lg-5 position-relative ">
            ...
            <div className="care-image">
              ...
              <div className="text-care">
                ...
                <p>Who diminution astonished. Yet uncommonly his ten who diminution astonished.</p>
              </div>
          ...
          <div className="col-md-6 col-lg-4 text-center">
            <div className="care-image">
              ...
              <div className="text-care">
                <h5>Helping struggling students
                </h5>
                <p>Man children rejoiced. Yet uncommonly his ten who diminution astonished.
